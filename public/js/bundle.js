...
var NavbarActions = function () {
  function NavbarActions() {
    ...
    this.generateActions('updateOnlineUsers', 'updateAjaxAnimation', 'updateSearchQuery', 'getTopCharactersSuccess', 'getTopCharactersFail', 'findCharacterSuccess', 'findCharacterFail');
  }
  ...
  _createClass(NavbarActions, [{
    ...
    value: function getCharacterCount() {
      ...
      $.ajax({ url: '/api/characters/count' }).done(function (data) {
        ...
        _this2.actions.getTopCharactCountFail(jqXhr);
      });
    }
  }]);
			...
			var leaderboardCharacters = this.state.characters.map(function (character) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: '/characters/' + character.characterId },
						_react2.default.createElement('img', { className: 'thumb-db', src: 'http://image.eveonline.com/Character/' + character.characterId + '_128.jpg' })
					)
				);
			});
...
var HomeStore = function () {
  ...
  _createClass(HomeStore, [{
    ...
    value: function onVoteFail(errorMessage) {
      toastr.console.error(errorMessage);
    }
  }]);
